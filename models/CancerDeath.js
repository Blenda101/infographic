...
var infoGraphicCancerDeathSchema = new mongoose_1.Schema({
    Year: String,
    Locationabbr: String,
    Locationdesc: String,
    Topic: String,
...
var InfoGraphicCancerDeath = (0, mongoose_1.model)('infoGraphicCancerDeath', infoGraphicCancerDeathSchema);
